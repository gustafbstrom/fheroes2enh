...
void
CastleRedrawCurrentBuilding(const Castle&, const Point&, const CastleDialog::CacheBuildings&, uint32_t build,
                            uint32_t flash);
    ...
    if (BUILD_SHIPYARD == build)
    {
        ...
        if (Race::SORC == castle.GetRace() && BUILD_WEL2 == build)
        {
            ...
            if (const uint32_t index2 = ICN::AnimationFrame(icn2, 0, frame))
            {
                ...
                CastleDialog::RedrawBuildingSpriteToArea(sprite21, dst_pt.x + sprite21.x(), dst_pt.y + sprite21.y(),
                                                         max);
            }
        }
}
...
Rect CastleGetCoordBuilding(int race, building_t building, const Point& pt)
{
    ...
    case BUILD_THIEVESGUILD:
        ...
        {
        case Race::KNGT:
            return {pt.x + 0, pt.y + 130, 50, 60};
        case Race::BARB:
            return {pt.x + 478, pt.y + 100, 76, 42};
        case Race::SORC:
            return {pt.x + 423, pt.y + 165, 65, 49};
        case Race::WRLK:
            return {pt.x + 525, pt.y + 109, 60, 48};
        case Race::WZRD:
            return {pt.x + 507, pt.y + 55, 47, 42};
        case Race::NECR:
            return {pt.x + 291, pt.y + 134, 43, 59};
        default:
            break;
        }
        break;
    ...
    case BUILD_TAVERN:
        ...
        {
        case Race::KNGT:
            return {pt.x + 350, pt.y + 110, 46, 56};
        case Race::BARB:
            return {pt.x + 0, pt.y + 205, 125, 60};
        case Race::SORC:
            return {pt.x + 494, pt.y + 140, 131, 87};
        case Race::WRLK:
            return {pt.x + 479, pt.y + 100, 39, 52};
        case Race::WZRD:
            return {pt.x, pt.y + 160, 118, 50};
        default:
            break;
        }
        break;
    ...
    case BUILD_SHIPYARD:
        ...
        {
        case Race::KNGT:
            return {pt.x + 537, pt.y + 221, 103, 33};
        case Race::BARB:
            return {pt.x + 535, pt.y + 210, 105, 45};
        case Race::SORC:
            return {pt.x + 0, pt.y + 220, 134, 35};
        case Race::WRLK:
            return {pt.x + 520, pt.y + 206, 120, 47};
        case Race::WZRD:
            return {pt.x, pt.y + 218, 185, 35};
        case Race::NECR:
            return {pt.x + 516, pt.y + 221, 124, 28};
        default:
            break;
        }
        break;
    ...
    case BUILD_WELL:
        ...
        {
        case Race::KNGT:
            return {pt.x + 194, pt.y + 225, 29, 27};
        case Race::BARB:
            return {pt.x + 272, pt.y + 215, 44, 32};
        case Race::SORC:
            return {pt.x + 346, pt.y + 209, 43, 25};
        case Race::WRLK:
            return {pt.x + 348, pt.y + 221, 63, 30};
        case Race::WZRD:
            return {pt.x + 254, pt.y + 143, 19, 28};
        case Race::NECR:
            return {pt.x + 217, pt.y + 225, 23, 26};
        default:
            break;
        }
        break;
    ...
    case BUILD_STATUE:
        ...
        {
        case Race::KNGT:
            return {pt.x + 480, pt.y + 205, 45, 50};
        case Race::BARB:
            return {pt.x + 470, pt.y + 180, 30, 58};
        case Race::SORC:
            return {pt.x + 158, pt.y + 173, 17, 58};
        case Race::WRLK:
            return {pt.x + 473, pt.y + 172, 45, 51};
        case Race::WZRD:
            return {pt.x + 464, pt.y + 58, 26, 62};
        case Race::NECR:
            return {pt.x + 374, pt.y + 174, 26, 70};
        default:
            break;
        }
        break;
    ...
    case BUILD_MARKETPLACE:
        ...
        {
        case Race::KNGT:
            return {pt.x + 220, pt.y + 144, 115, 20};
        case Race::BARB:
            return {pt.x + 224, pt.y + 168, 52, 36};
        case Race::SORC:
            return {pt.x + 412, pt.y + 122, 56, 40};
        case Race::WRLK:
            return {pt.x + 391, pt.y + 185, 70, 26};
        case Race::WZRD:
            return {pt.x + 254, pt.y + 176, 105, 39};
        case Race::NECR:
            return {pt.x + 415, pt.y + 216, 85, 35};
        default:
            break;
        }
        break;
    ...
    case BUILD_WEL2:
        ...
        {
        case Race::KNGT:
            return {pt.x + 288, pt.y + 97, 63, 18};
        case Race::BARB:
            return {pt.x + 252, pt.y + 120, 44, 16};
        case Race::SORC:
            return {pt.x + 135, pt.y + 200, 63, 31};
        case Race::WRLK:
            return {pt.x + 69, pt.y + 46, 24, 124};
        case Race::WZRD:
            return {pt.x + 234, pt.y + 225, 107, 22};
        case Race::NECR:
            return {pt.x + 275, pt.y + 206, 68, 39};
        default:
            break;
        }
        break;
    ...
    case BUILD_MOAT:
        ...
        {
        case Race::KNGT:
            return {pt.x + 53, pt.y + 150, 93, 30};
        case Race::BARB:
            return {pt.x + 113, pt.y + 155, 106, 30};
        case Race::SORC:
            return {pt.x + 143, pt.y + 169, 98, 11};
        case Race::WRLK:
            return {pt.x + 327, pt.y + 166, 66, 17};
        case Race::WZRD:
            return {pt.x, pt.y + 91, 198, 11};
        case Race::NECR:
            return {pt.x + 336, pt.y + 169, 71, 15};
        default:
            break;
        }
        break;
    ...
    case BUILD_SPEC:
        ...
        {
        case Race::KNGT:
            return {pt.x + 0, pt.y + 80, 250, 20};
        case Race::BARB:
            return {pt.x + 223, pt.y + 79, 124, 27};
        case Race::SORC:
            return {pt.x + 147, pt.y + 0, 252, 30};
        case Race::WRLK:
            return {pt.x, pt.y + 162, 70, 77};
        case Race::WZRD:
            return {pt.x + 304, pt.y + 111, 95, 50};
        case Race::NECR:
            return {pt.x, pt.y, 640, 54};
        default:
            break;
        }
        break;
    ...
    case BUILD_CASTLE:
        ...
        {
        case Race::KNGT:
            return {pt.x + 0, pt.y + 55, 290, 85};
        case Race::BARB:
            return {pt.x + 0, pt.y + 88, 202, 62};
        case Race::SORC:
            return {pt.x + 0, pt.y + 67, 198, 100};
        case Race::WRLK:
            return {pt.x + 268, pt.y + 35, 131, 129};
        case Race::WZRD:
            return {pt.x, pt.y + 48, 187, 39};
        case Race::NECR:
            return {pt.x + 322, pt.y + 63, 73, 97};
        default:
            break;
        }
        break;
    ...
    case BUILD_CAPTAIN:
        ...
        {
        case Race::KNGT:
            return {pt.x + 293, pt.y + 109, 48, 27};
        case Race::BARB:
            return {pt.x + 210, pt.y + 104, 40, 35};
        case Race::SORC:
            return {pt.x + 238, pt.y + 136, 32, 34};
        case Race::WRLK:
            return {pt.x + 420, pt.y + 102, 52, 60};
        case Race::WZRD:
            return {pt.x + 210, pt.y + 55, 28, 32};
        case Race::NECR:
            return {pt.x + 423, pt.y + 126, 41, 46};
        default:
            break;
        }
        break;
    ...
    case BUILD_MAGEGUILD1:
        ...
        {
        case Race::KNGT:
            return {pt.x + 398, pt.y + 150, 58, 30};
        case Race::BARB:
            return {pt.x + 348, pt.y + 118, 50, 25};
        case Race::SORC:
            return {pt.x + 285, pt.y + 32, 55, 129};
        case Race::WRLK:
            return {pt.x + 590, pt.y + 135, 50, 35};
        case Race::WZRD:
            return {pt.x + 583, pt.y + 73, 57, 48};
        case Race::NECR:
            return {pt.x + 565, pt.y + 131, 73, 74};
        default:
            break;
        }
        break;
    ...
    case BUILD_MAGEGUILD2:
        ...
        {
        case Race::KNGT:
            return {pt.x + 398, pt.y + 128, 58, 52};
        case Race::BARB:
            return {pt.x + 348, pt.y + 94, 50, 49};
        case Race::SORC:
            return {pt.x + 285, pt.y + 32, 55, 129};
        case Race::WRLK:
            return {pt.x + 590, pt.y + 108, 50, 60};
        case Race::WZRD:
            return {pt.x + 585, pt.y + 69, 55, 50};
        case Race::NECR:
            return {pt.x + 568, pt.y + 102, 62, 104};
        default:
            break;
        }
        break;
    ...
    case BUILD_MAGEGUILD3:
        ...
        {
        case Race::KNGT:
            return {pt.x + 398, pt.y + 105, 58, 75};
        case Race::BARB:
            return {pt.x + 348, pt.y + 72, 50, 72};
        case Race::SORC:
            return {pt.x + 285, pt.y + 32, 55, 129};
        case Race::WRLK:
            return {pt.x + 590, pt.y + 77, 50, 90};
        case Race::WZRD:
            return {pt.x + 585, pt.y + 44, 55, 78};
        case Race::NECR:
            return {pt.x + 570, pt.y + 79, 56, 130};
        default:
            break;
        }
        break;
    ...
    case BUILD_MAGEGUILD4:
        ...
        {
        case Race::KNGT:
            return {pt.x + 398, pt.y + 85, 58, 95};
        case Race::BARB:
            return {pt.x + 348, pt.y + 48, 50, 96};
        case Race::SORC:
            return {pt.x + 285, pt.y + 32, 55, 129};
        case Race::WRLK:
            return {pt.x + 590, pt.y + 45, 50, 125};
        case Race::WZRD:
            return {pt.x + 585, pt.y + 20, 54, 102};
        case Race::NECR:
            return {pt.x + 570, pt.y + 61, 60, 146};
        default:
            break;
        }
        break;
    ...
    case BUILD_MAGEGUILD5:
        ...
        {
        case Race::KNGT:
            return {pt.x + 398, pt.y + 55, 58, 125};
        case Race::BARB:
            return {pt.x + 348, pt.y + 20, 50, 124};
        case Race::SORC:
            return {pt.x + 285, pt.y + 32, 55, 129};
        case Race::WRLK:
            return {pt.x + 590, pt.y + 14, 50, 155};
        case Race::WZRD:
            return {pt.x + 585, pt.y, 57, 122};
        case Race::NECR:
            return {pt.x + 570, pt.y + 45, 61, 162};
        default:
            break;
        }
        break;
    ...
    case BUILD_TENT:
        ...
        {
        case Race::KNGT:
            return {pt.x + 82, pt.y + 132, 42, 30};
        case Race::BARB:
            return {pt.x + 53, pt.y + 119, 67, 35};
        case Race::SORC:
            return {pt.x + 88, pt.y + 145, 62, 36};
        case Race::WRLK:
            return {pt.x + 308, pt.y + 140, 52, 28};
        case Race::WZRD:
            return {pt.x + 60, pt.y + 68, 46, 33};
        case Race::NECR:
            return {pt.x + 333, pt.y + 131, 49, 51};
        default:
            break;
        }
        break;
    ...
    case DWELLING_MONSTER1:
        ...
        {
        case Race::KNGT:
            return {pt.x + 195, pt.y + 175, 50, 40};
        case Race::BARB:
            return {pt.x + 258, pt.y + 142, 71, 41};
        case Race::SORC:
            return {pt.x + 478, pt.y + 70, 92, 62};
        case Race::WRLK:
            return {pt.x, pt.y + 63, 68, 53};
        case Race::WZRD:
            return {pt.x + 459, pt.y + 181, 45, 32};
        case Race::NECR:
            return {pt.x + 404, pt.y + 181, 56, 25};
        default:
            break;
        }
        break;
    ...
    case DWELLING_UPGRADE2:
        ...
        {
        case Race::KNGT:
            return {pt.x + 145, pt.y + 155, 58, 20};
        case Race::BARB:
            return {pt.x + 152, pt.y + 190, 68, 50};
        case Race::SORC:
            return {pt.x + 345, pt.y + 149, 70, 56};
        case Race::WRLK:
            return {pt.x + 248, pt.y + 192, 60, 55};
        case Race::WZRD:
            return {pt.x + 253, pt.y + 69, 90, 29};
        case Race::NECR:
            return {pt.x + 147, pt.y + 184, 92, 32};
        default:
            break;
        }
        break;
    ...
    case DWELLING_UPGRADE3:
        ...
        {
        case Race::KNGT:
            return {pt.x + 250, pt.y + 177, 70, 50};
        case Race::BARB:
            return {pt.x + 582, pt.y + 81, 58, 40};
        case Race::SORC:
            return {pt.x + 90, pt.y + 180, 56, 21};
        case Race::WRLK:
            return {pt.x + 504, pt.y + 53, 38, 30};
        case Race::WZRD:
            return {pt.x + 156, pt.y + 139, 74, 51};
        case Race::NECR:
            return {pt.x + 108, pt.y + 69, 117, 91};
        default:
            break;
        }
        break;
    ...
    case DWELLING_UPGRADE4:
        ...
        {
        case Race::KNGT:
            return {pt.x + 328, pt.y + 195, 100, 50};
        case Race::BARB:
            return {pt.x + 509, pt.y + 148, 123, 57};
        case Race::SORC:
            return {pt.x + 208, pt.y + 182, 127, 55};
        case Race::WRLK:
            return {pt.x + 154, pt.y + 168, 171, 76};
        case Race::WZRD:
            return {pt.x + 593, pt.y + 187, 47, 28};
        case Race::NECR:
            return {pt.x, pt.y + 154, 140, 74};
        default:
            break;
        }
        break;
    ...
    case DWELLING_UPGRADE5:
        ...
        {
        case Race::KNGT:
            return {pt.x + 0, pt.y + 200, 150, 55};
        case Race::BARB:
            return {pt.x + 331, pt.y + 186, 121, 44};
        case Race::SORC:
            return {pt.x + 345, pt.y + 231, 165, 21};
        case Race::WRLK:
            return {pt.x + 149, pt.y + 98, 95, 58};
        case Race::WZRD:
            return {pt.x + 417, pt.y + 25, 35, 140};
        case Race::NECR:
            return {pt.x + 235, pt.y + 136, 53, 70};
        default:
            break;
        }
        break;
    ...
    case DWELLING_UPGRADE7:
        ...
        {
        case Race::KNGT:
            return {pt.x + 465, pt.y + 85, 175, 110};
        case Race::BARB:
            return {pt.x + 407, pt.y + 13, 109, 80};
        case Race::SORC:
            return {pt.x + 202, pt.y + 38, 42, 65};
        case Race::WRLK:
            return {pt.x + 98, pt.y + 25, 55, 229};
        case Race::WZRD:
            return {pt.x + 196, pt.y + 7, 129, 38};
        case Race::NECR:
